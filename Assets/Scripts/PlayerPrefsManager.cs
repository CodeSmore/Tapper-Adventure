...
public class PlayerPrefsManager : MonoBehaviour {
	...
	public static void SaveGame (int level, float experiencePoints, float currentHealth, float currentEnergy, float timerSkill1, float timerSkill2, float timerSkill3, Vector3 lastKnowPos, string spawnType, int[] bosses) {
